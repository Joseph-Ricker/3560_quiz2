...
*	@file college.cc
*
*	@brief This is the implementation file for the college class
*
...
/**
*	@brief This function adds a new node to a linked list
*
*	@param This function takes a course, which gives info of the course to fill the node
*
*	@return This is a void function so no there is no return value
*/
...
/**
*	@brief This function removes a specific course from the linked list
*
*	@param This function takes a coursename to search for
*
*	@return This is a void function so there will be no return value
*/
